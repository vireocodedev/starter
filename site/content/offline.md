...
The [pinned Template offline guide](https://github.com/vireocodedev/starter-template/blob/a24f9435d3f624fb1962c3d5c4e3457b69f5be28/docs/offline.md) and its [PWA policy](https://github.com/vireocodedev/starter-template/blob/a24f9435d3f624fb1962c3d5c4e3457b69f5be28/frontend/pwa-policy.mjs) are the reviewable source for this release. The framework publishes the separate [offline primitive contract](https://github.com/vireocodedev/starter/blob/b068ba6b51c4c93430b0fed167cd3427e7082277/docs/OFFLINE_GUARANTEES.md), including compile-checked [TypeScript](https://github.com/vireocodedev/starter/blob/b068ba6b51c4c93430b0fed167cd3427e7082277/packages/sqlite/docs/examples/orderQuantityOfflineReplay.example.ts) and [JVM](https://github.com/vireocodedev/starter/blob/b068ba6b51c4c93430b0fed167cd3427e7082277/jvm/vireo-starter-documentation-examples/src/main/java/com/vireocode/docs/offline/OfflineReplayConfigurationExample.java) examples. Adopt that separate primitive layer only when building the application-owned domain-capability row.
