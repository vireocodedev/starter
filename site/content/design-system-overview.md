...
- [Visual language](https://github.com/vireocodedev/starter-template/blob/5b123e60bd1ce733ae70711796552a17aaa60fe3/frontend/docs/VISUAL_LANGUAGE.md), [responsive shell](https://github.com/vireocodedev/starter-template/blob/5b123e60bd1ce733ae70711796552a17aaa60fe3/frontend/docs/architecture/routing-and-shell.md), and [motion](https://github.com/vireocodedev/starter-template/blob/5b123e60bd1ce733ae70711796552a17aaa60fe3/frontend/docs/INTERACTION_MOTION.md) use the Starter Template reference composition.
...
- [Forms and validation](https://github.com/vireocodedev/starter-template/blob/5b123e60bd1ce733ae70711796552a17aaa60fe3/frontend/docs/architecture/models-forms-and-validation.md), [authentication and errors](https://github.com/vireocodedev/starter-template/blob/5b123e60bd1ce733ae70711796552a17aaa60fe3/frontend/docs/architecture/authentication-and-errors.md), and [localization](https://github.com/vireocodedev/starter-template/blob/5b123e60bd1ce733ae70711796552a17aaa60fe3/frontend/docs/architecture/localization.md) are Starter Template reference conventions.
- [Quality and release](https://github.com/vireocodedev/starter-template/blob/5b123e60bd1ce733ae70711796552a17aaa60fe3/frontend/docs/architecture/storybook-and-testing.md) records the associated verification model.
