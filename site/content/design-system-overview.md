...
- [Visual language](https://github.com/vireocodedev/vireo-template/blob/421ae56cdd6d1fa6863cc6f29503b15294e4aa99/frontend/docs/VISUAL_LANGUAGE.md), [responsive shell](https://github.com/vireocodedev/vireo-template/blob/421ae56cdd6d1fa6863cc6f29503b15294e4aa99/frontend/docs/architecture/routing-and-shell.md), and [motion](https://github.com/vireocodedev/vireo-template/blob/421ae56cdd6d1fa6863cc6f29503b15294e4aa99/frontend/docs/INTERACTION_MOTION.md) use the current 0.8.2 Template reference composition.
...
- [Forms and validation](https://github.com/vireocodedev/vireo-template/blob/421ae56cdd6d1fa6863cc6f29503b15294e4aa99/frontend/docs/architecture/models-forms-and-validation.md), [authentication and errors](https://github.com/vireocodedev/vireo-template/blob/421ae56cdd6d1fa6863cc6f29503b15294e4aa99/frontend/docs/architecture/authentication-and-errors.md), and [localization](https://github.com/vireocodedev/vireo-template/blob/421ae56cdd6d1fa6863cc6f29503b15294e4aa99/frontend/docs/architecture/localization.md) are Template reference conventions.
- [Quality and release](https://github.com/vireocodedev/vireo-template/blob/421ae56cdd6d1fa6863cc6f29503b15294e4aa99/frontend/docs/architecture/storybook-and-testing.md) records the associated verification model.
