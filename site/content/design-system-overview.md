...
- [Visual language](https://github.com/vireocodedev/vireo-template/blob/12485e7e7e9323a802d79c793d230557cad4c7fb/frontend/docs/VISUAL_LANGUAGE.md), [responsive shell](https://github.com/vireocodedev/vireo-template/blob/12485e7e7e9323a802d79c793d230557cad4c7fb/frontend/docs/architecture/routing-and-shell.md), and [motion](https://github.com/vireocodedev/vireo-template/blob/12485e7e7e9323a802d79c793d230557cad4c7fb/frontend/docs/INTERACTION_MOTION.md) use the current 0.8.3 Template reference composition.
...
- [Forms and validation](https://github.com/vireocodedev/vireo-template/blob/12485e7e7e9323a802d79c793d230557cad4c7fb/frontend/docs/architecture/models-forms-and-validation.md), [authentication and errors](https://github.com/vireocodedev/vireo-template/blob/12485e7e7e9323a802d79c793d230557cad4c7fb/frontend/docs/architecture/authentication-and-errors.md), and [localization](https://github.com/vireocodedev/vireo-template/blob/12485e7e7e9323a802d79c793d230557cad4c7fb/frontend/docs/architecture/localization.md) are Template reference conventions.
- [Quality and release](https://github.com/vireocodedev/vireo-template/blob/12485e7e7e9323a802d79c793d230557cad4c7fb/frontend/docs/architecture/storybook-and-testing.md) records the associated verification model.
