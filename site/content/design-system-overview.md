...
- [Visual language](https://github.com/vireocodedev/starter-template/blob/eed5c2dc3f53f53ef48a44e1d4e3394cb67feeeb/frontend/docs/VISUAL_LANGUAGE.md), [responsive shell](https://github.com/vireocodedev/starter-template/blob/eed5c2dc3f53f53ef48a44e1d4e3394cb67feeeb/frontend/docs/architecture/routing-and-shell.md), and [motion](https://github.com/vireocodedev/starter-template/blob/eed5c2dc3f53f53ef48a44e1d4e3394cb67feeeb/frontend/docs/INTERACTION_MOTION.md) use the Starter Template reference composition.
...
- [Forms and validation](https://github.com/vireocodedev/starter-template/blob/eed5c2dc3f53f53ef48a44e1d4e3394cb67feeeb/frontend/docs/architecture/models-forms-and-validation.md), [authentication and errors](https://github.com/vireocodedev/starter-template/blob/eed5c2dc3f53f53ef48a44e1d4e3394cb67feeeb/frontend/docs/architecture/authentication-and-errors.md), and [localization](https://github.com/vireocodedev/starter-template/blob/eed5c2dc3f53f53ef48a44e1d4e3394cb67feeeb/frontend/docs/architecture/localization.md) are Starter Template reference conventions.
- [Quality and release](https://github.com/vireocodedev/starter-template/blob/eed5c2dc3f53f53ef48a44e1d4e3394cb67feeeb/frontend/docs/architecture/storybook-and-testing.md) records the associated verification model.
