...
[![The current Vireo flagship operational application](https://raw.githubusercontent.com/vireocodedev/vireo-template/09cd526d32907bedfe5bb6ab45a2d4d221b0d47b/docs/assets/flagship-overview.png)](https://demo.vireocode.com)
...
| --------------------------------------------------------- | ------- | --------------------------------------------------------------------------------------------------------- |
| [`create-vireo`](packages/create-vireo)                   | 0.8.4   | Project creation/upgrade plus full-stack and frontend-target entity, contract-check, and ejection CLI.    |
