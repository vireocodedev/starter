...
[![The current Vireo flagship operational application](https://raw.githubusercontent.com/vireocodedev/vireo-template/421ae56cdd6d1fa6863cc6f29503b15294e4aa99/docs/assets/flagship-overview.png)](https://demo.vireocode.com)
...
in `create-vireo@0.8.2`. Its version-aware
project upgrade currently supports the explicit adjacent 0.8.1→0.8.2 release
pair; 0.8.0→0.8.1 remains retained historical evidence; 0.7.0→0.8.0 remains retained historical evidence; the 0.6.0→0.7.0 and original 0.2.0→0.3.0 pairs remain retained historical evidence.
...
| --------------------------------------------------------- | ------- | --------------------------------------------------------------------------------------------------------- |
| [`create-vireo`](packages/create-vireo)                   | 0.8.2   | Project creation/upgrade plus full-stack and frontend-target entity, contract-check, and ejection CLI.    |
