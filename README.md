...
[![The current Vireo flagship operational application](https://raw.githubusercontent.com/vireocodedev/vireo-template/12485e7e7e9323a802d79c793d230557cad4c7fb/docs/assets/flagship-overview.png)](https://demo.vireocode.com)
...
in `create-vireo@0.8.3`. Its version-aware
project upgrade currently supports the explicit adjacent 0.8.2→0.8.3 release
pair; 0.8.1→0.8.2 remains retained historical evidence; 0.8.0→0.8.1 remains retained historical evidence; 0.7.0→0.8.0 remains retained historical evidence; the 0.6.0→0.7.0 and original 0.2.0→0.3.0 pairs remain retained historical evidence.
...
| --------------------------------------------------------- | ------- | --------------------------------------------------------------------------------------------------------- |
| [`create-vireo`](packages/create-vireo)                   | 0.8.3   | Project creation/upgrade plus full-stack and frontend-target entity, contract-check, and ejection CLI.    |
