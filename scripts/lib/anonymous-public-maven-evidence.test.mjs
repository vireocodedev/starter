...
test("Maven evidence binds coordinate and license checks", () => {
  const record = { group: "com.vireocode", module: "vireo-core", version: "0.3.1", extension: "pom", classifier: "", pomMitLicense: true, binaryJarMitLicense: false, checksumVerified: true, signatureVerified: true };
