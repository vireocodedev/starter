 ...
 * {@link com.vireocode.starter.auth.StarterAuthProperties},
 * {@link com.vireocode.starter.auth.StarterHttpSecurityCustomizer}, and—only
 * when deliberately using the default database store—
 * {@link com.vireocode.starter.auth.StarterUser} with
 * {@link com.vireocode.starter.auth.StarterUserRepository}. Controllers and the
