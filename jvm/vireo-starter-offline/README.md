...
`vireo-starter-offline` provides authenticated mutation replay, idempotent command tracking, per-entity hydration revisions, and transaction-aware server-sent change batches for row-shaped applications.
