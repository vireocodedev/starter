...
declare module "@mui/material/styles" {
  interface ComponentsPropsList {
    [VIREO_FORM_RADIO_GROUP_FIELD_NAME]: VireoFormRadioGroupFieldProps;
  }
  interface ComponentNameToClassKey {
    [VIREO_FORM_RADIO_GROUP_FIELD_NAME]: VireoFormRadioGroupFieldClassKey;
  }
  interface Components<Theme = unknown> {
    [VIREO_FORM_RADIO_GROUP_FIELD_NAME]?: {
      defaultProps?: ComponentsProps[typeof VIREO_FORM_RADIO_GROUP_FIELD_NAME];
      styleOverrides?: ComponentsOverrides<Theme>[typeof VIREO_FORM_RADIO_GROUP_FIELD_NAME];
      variants?: ComponentsVariants<Theme>[typeof VIREO_FORM_RADIO_GROUP_FIELD_NAME];
    };
  }
}
