...
declare module "@mui/material/styles" {
  interface ComponentsPropsList {
    [VIREO_FORM_SECTION_ITEM_NAME]: VireoFormSectionItemProps;
  }

  interface ComponentNameToClassKey {
    [VIREO_FORM_SECTION_ITEM_NAME]: VireoFormSectionItemClassKey;
  }

  interface Components<Theme = unknown> {
    [VIREO_FORM_SECTION_ITEM_NAME]?: {
      defaultProps?: ComponentsProps[typeof VIREO_FORM_SECTION_ITEM_NAME];
      styleOverrides?: ComponentsOverrides<Theme>[typeof VIREO_FORM_SECTION_ITEM_NAME];
      variants?: ComponentsVariants<Theme>[typeof VIREO_FORM_SECTION_ITEM_NAME];
    };
  }
}
