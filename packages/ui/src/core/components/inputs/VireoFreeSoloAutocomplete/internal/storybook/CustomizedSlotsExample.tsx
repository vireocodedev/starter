...
export default function CustomizedSlotsExample() {
  const [value, setValue] = React.useState<string | null>("bug");
  return (
    <VireoStorybookProvider>
      <VireoFreeSoloAutocomplete
        ...
        addIcon={<Add />}
        slots={{ root: "section" }}
        slotProps={{ root: { "aria-label": "Issue label editor", sx: { p: 2, border: 1, borderColor: "divider" } } }}
        textFieldProps={{ label: "Issue label" }}
      />
    </VireoStorybookProvider>
  );
}
