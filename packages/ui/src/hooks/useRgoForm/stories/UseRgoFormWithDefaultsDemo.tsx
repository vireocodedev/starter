...
export function UseFormWithDefaultsDemo(props: Pick<UseFormProps<BasicFormData>, "defaultValues" | "schema">) {
  return (
    <Box sx={{ p: 3 }}>
      <RgoLabelBox label="Basic useRgoForm Hook Usage with RgoForm">
        <FormDemo {...props} />
      </RgoLabelBox>
    </Box>
  );
...
export const UseFormWithDefaultsDemoCode = `
