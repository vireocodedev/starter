...
type RgoInputSelectWithErrorDemoProps = Partial<
  Omit<RgoInputSelectProps<Option, number>, "value" | "onChange" | "options" | "renderOption" | "renderValue">
>;

export function RgoInputSelectWithErrorDemo(
  props: RgoInputSelectWithErrorDemoProps = {
    error: true,
...
export const RgoInputSelectWithErrorDemoCode = `
...
type RgoInputSelectWithErrorDemoProps = Partial<Omit<RgoInputSelectProps<Option, number>, "value" | "onChange" | "options" | "renderOption" | "renderValue">>;
