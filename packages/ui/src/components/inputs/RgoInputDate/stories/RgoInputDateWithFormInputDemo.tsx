...
export function RgoInputDateWithFormInputDemo() {
                ...
                <RgoLabelBox label="Input field" required>
                  <Controller
                    ...
                    render={({ field, fieldState }) => (
                      <RgoInputDate {...field} error={fieldState.invalid} helperText={fieldState.error?.message} />
                    )}
                  />
                </RgoLabelBox>
              </Grid>
...
export const RgoInputDateWithFormInputDemoCode = `
import { 
  RgoLabelBox,
  RgoForm,
  RgoInputDate,
