...
type RgoInputSelectMultipleWithHelperTextDemoProps = Partial<
  Omit<RgoInputSelectMultipleProps<Option, number>, "value" | "onChange" | "options" | "renderOption" | "renderValue">
>;

export function RgoInputSelectMultipleWithHelperTextDemo(props: RgoInputSelectMultipleWithHelperTextDemoProps = {}) {
...
export const RgoInputSelectMultipleWithHelperTextDemoCode = `
...
type RgoInputSelectMultipleWithHelperTextDemoProps = Partial<Omit<RgoInputSelectMultipleProps<Option, number>, "value" | "onChange" | "options" | "renderOption" | "renderValue">>;
