...
type RgoInputAutocompleteWithErrorDemoProps = Partial<
  Omit<
...
export function RgoInputAutocompleteWithErrorDemo(props: RgoInputAutocompleteWithErrorDemoProps = {}) {
...
export const RgoInputAutocompleteWithErrorDemoCode = `import { RgoLabelBox, RgoInputAutocomplete } from "@vireocodedev/starter-ui";
import React from "react";
