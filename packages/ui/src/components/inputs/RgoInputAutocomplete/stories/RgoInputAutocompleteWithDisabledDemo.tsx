...
type RgoInputAutocompleteWithDisabledDemoProps = Partial<
  Omit<
...
export function RgoInputAutocompleteWithDisabledDemo(props: RgoInputAutocompleteWithDisabledDemoProps = {}) {
  const [value, setValue] = React.useState<Option | null>(mockOptions[1]); // Pre-select Banana
  const [searchText, setSearchText] = React.useState("Banana");
...
export const RgoInputAutocompleteWithDisabledDemoCode = `import { RgoLabelBox, RgoInputAutocomplete } from "@vireocodedev/starter-ui";
import React from "react";
