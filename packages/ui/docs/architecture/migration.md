...
| `components/data-display/{RgoIcon,RgoPdfFrame,RgoSnack,RgoStatusDot,RgoStatusText,RgoStopwatch,RgoTimeWithDateDisplay,RgoTimeWithDateDisplayInline,RgoTruncatedText,RgoValueWithUnit}/**` | `core/components`                            | Split       | Classify as data-display, feedback, or surfaces; keep thin Rgo aliases where required. |
