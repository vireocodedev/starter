...
| `capabilities/forms/contexts/{VireoFormContext,VireoFormHookContexts}/**`                                           | `capabilities/forms/contexts`          | Migrated      | Private form presentation policy and TanStack binding contexts.                                                                        |
