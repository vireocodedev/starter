...
| `overlay/PageOverlayController.tsx`                                                                                 | `capabilities/overlays/page-overlays`  | Split         | Mixed provider and public component responsibilities require separation.                                                               |
| `table/**`                                                                                                          | `capabilities/table`                   | Split         | Parent table foundations plus `responsive-table` and `management-table`.                                                               |
| `unsaved-changes/{UnsavedChangesScope.tsx,useUnsavedChangesRegistration.ts,useUnsavedChangesRequestDiscard.ts}`     | `capabilities/unsaved-changes`         | Planned       | Remaining scope component and public hooks.                                                                                            |
