...
| `overlay/**`                    | `capabilities/overlays`                | Split         | Shared overlay primitives plus child `page-overlays`.                                                                                  |
...
| `components/data-display/{RgoIcon,RgoIconContainer,RgoJsonViewer,RgoLabelBox,RgoPdfFrame,RgoSnack,RgoStatusDot,RgoStatusText,RgoStopwatch,RgoTimeWithDateDisplay,RgoTimeWithDateDisplayInline,RgoTruncatedText,RgoValueWithUnit,VireoIconContainer,VireoLabelBox,VireoTruncatedContent}/**` | `core/components`                            | Split       | Classify as data-display, feedback, or surfaces; keep thin Rgo aliases where required. |
