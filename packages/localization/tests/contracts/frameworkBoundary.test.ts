...
const forbiddenPackages = new Set(["react", "react-dom", "react-i18next", "@types/react", "@types/react-dom"]);
...
describe("starter-localization framework boundary", () => {
  it("contains no TSX, React contract, or browser-global dependency", () => {
