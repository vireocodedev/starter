...
edge is 0.8.1→0.8.2; 0.8.0→0.8.1 remains retained historical evidence; 0.7.0→0.8.0 remains retained historical evidence; 0.6.0→0.7.0 and 0.2.0→0.3.0 remain retained historical evidence. Numeric
