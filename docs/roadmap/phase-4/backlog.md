...
open. The current public `create-vireo@0.8.4` line and its supported 0.8.3→0.8.4
adjacent upgrade fixture are complete; 0.8.2→0.8.3 remains retained historical evidence.
