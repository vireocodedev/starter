...
open. The current public `create-vireo@0.8.1` line and its supported 0.8.0→0.8.1
adjacent upgrade fixture are complete; 0.7.0→0.8.0 remains retained historical evidence.
