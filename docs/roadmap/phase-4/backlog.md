...
open. The current public `create-vireo@0.8.2` line and its supported 0.8.1→0.8.2
adjacent upgrade fixture are complete; 0.8.0→0.8.1 remains retained historical evidence.
