...
open. The current public `create-vireo@0.8.3` line and its supported 0.8.2→0.8.3
adjacent upgrade fixture are complete; 0.8.1→0.8.2 remains retained historical evidence.
