...
- [x] Historical milestone: publish `create-vireo@0.4.0` with npm provenance and pin generated projects; the current release-prepared frontend profile is `create-vireo@0.8.0`.
