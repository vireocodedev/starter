...
| Hosted setup binding          | Template `9c77b6e`; root setup is now the documented and CI-executed install path.                                                                                                                                                                                                           |
| Exact public archive          | `create-vireo` generated from pinned full commit `9c77b6e1a2b456cb4250f434655e60170b286e05`; project name, Java package, database, metadata, README, PWA name, and localized brand were customized.                                                                                          |
