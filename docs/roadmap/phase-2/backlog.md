...
| `P2-08` | Clean-room and exit evidence  | Automated matrices pass; at least 70% of unfamiliar external human testers run the app without help.                                                                         | Engineering evidence complete except local PostgreSQL launch (Docker unavailable); human gate needs validation |
