...
| `P2-02` | Canonical create coordinate   | `npm create vireo@latest` maps to public package `create-vireo`; npm is the one Phase 2 package manager.                                                                     | Done; `create-vireo@0.8.7` is public, anonymously verified, and attested        |
