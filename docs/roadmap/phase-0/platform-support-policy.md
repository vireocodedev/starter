...
| Java/Boot            | Java 21, Boot 4.1.1, and each repository wrapper pass Ubuntu CI; a nightly Java 25 compatibility lane is source-enforced              | Obtain the first green recurring Java 25 record and machine-check wrapper/BOM policy                 |
...
| PostgreSQL           | Nightly 17/18 Testcontainers lanes make Docker and the real upgrade fixture mandatory in Starter                                      | Obtain recurring green records and test Template migrations/queries against both                     |
