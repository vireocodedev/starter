...
Reconciled on 2026-08-27 at Starter commit
`4ff38f697403af977fd7825cbe2967c0f9968f45` and Starter Template commit
`ee5ecd251fa30655133e833b93de681bf2171c5c`. The dated measurements below remain
historical; current distribution and roadmap status supersede the original
pre-publication interpretation.
...
Vireo now has public framework and Template repositories, seven public npm packages
at `0.2.1` with registry provenance attestations, and six signed Maven Central
artifacts at `0.2.0`. The Template consumes those public coordinates anonymously.
External human positioning and demand validation has not occurred, the minimal
Template boundary is unresolved, the complete support matrix is not activated, and
the create/doctor/full-stack generation experience does not exist.
...
| 3. Product strategy and positioning                         | Provisional    | A precise persona, job, claim hierarchy, non-goals, scale envelope, and test protocol exist; the 2026-08-27 AI proxy supports provisional decisions, while human demand validation is deferred.                                            |
...
| 22. Security engineering and software supply chain          | Partial        | Security policy, pinned automation, scanning, npm provenance, Maven signatures, and protected publishing exist; threat modeling, hardening, complete SBOM policy, and independent review remain.                                           |
| 23. Packaging, versioning, compatibility, and releases      | Partial        | Public npm `0.2.1` and Maven Central `0.2.0` releases resolve anonymously; artifact-level compatibility, deprecation, migration, and supported-release policy remain incomplete.                                                           |
...
| 25. README and GitHub conversion surface                    | Partial        | Both repositories and the Starter Storybook are public, and the Template has a working quickstart; the framework README, visual proof, maturity funnel, and community entry points still need Phase 1 work.                                |
| 26. Demo and proof applications                             | Partial        | Template is a public rich proof application, but it is unhosted and its minimal-versus-kitchen-sink boundary is unresolved.                                                                                                                |
...
| 33. Launch and growth strategy                              | Missing        | Public source and artifacts exist, but there is no completed public-alpha launch package, demand validation, or adoption evidence.                                                                                                         |
| 34. Product analytics, research, and feedback loops         | Partial        | A [validation protocol](validation-protocol.md), [fieldwork/privacy runbook](research-operations.md), evidence taxonomy, and checkpoint format exist; no participant session, activation telemetry, or recurring adoption research exists. |
...
| 36. Competitive strategy and recurring review               | Partial        | A current official-source outcome matrix and [controlled hands-on protocol](competitor-benchmark-protocol.md) exist; benchmark results and a sustained twice-yearly review remain.                                                         |
...
[gap register](gap-register.md) provide the operational layer. The 2026-08-27 AI
proxy gate review records the Phase 0 disposition separately from this baseline.
...
| ------------------------------ | ------: | -----------: | ------------: | -----------------------: |
| `@vireocodedev/history`        |   0.2.1 |            1 |            35 |                        1 |
| `@vireocodedev/infrastructure` |   0.2.1 |            3 |            41 |                        2 |
| `@vireocodedev/localization`   |   0.2.1 |            1 |            42 |                        1 |
| `@vireocodedev/query`          |   0.2.1 |            1 |            60 |                        1 |
| `@vireocodedev/shell`          |   0.2.1 |            1 |            49 |                        1 |
| `@vireocodedev/sqlite`         |   0.2.1 |            2 |           154 |                        2 |
| `@vireocodedev/ui`             |   0.2.1 |           13 |         1,364 |                        0 |
| **Total**                      |         |       **22** |     **1,745** |                    **9** |
