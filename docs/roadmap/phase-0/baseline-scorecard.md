...
| 31. Legal, licensing, intellectual property, and compliance | Partial          | MIT license, security policy, and contributor code of conduct exist; naming/IP checks, dependency-license policy, and compliance guidance remain.           |
