...
| `P3-07` | Generated fixture CI         | A realistic Purchase Order slice compiles and executes on frontend and backend from a clean created project.                                                            | Done locally; hosted job added |
