...
The current supported 0.8.2-to-0.8.3 project upgrade admits declared manifests without
regeneration. The 0.8.1-to-0.8.2 edge remains retained historical evidence. The 0.8.0-to-0.8.1 edge remains retained historical evidence. The 0.7.0-to-0.8.0 edge remains retained historical evidence. `vireo check` fail-closes on its declared allowlist by checking the raw
