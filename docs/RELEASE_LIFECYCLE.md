...
The current `0.2-alpha` line is active and receives security and critical-correctness fixes. Alpha compatibility remains governed by [`docs/COMPATIBILITY.md`](COMPATIBILITY.md).
